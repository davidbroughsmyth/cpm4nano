...
/*0/8							1/9								2/A						3/B							4/C							5/D							6/E							7/F													*/
	...
	"ADD B",				"ADD C",				"ADD D",				"ADD E",				"ADD H",				"ADD L",				"ADD (HL)",			"ADD A",					/*	80-87 */
	"ADC B",				"ADC C",				"ADC D",				"ADC E",				"ADC H",				"ADC L",				"ADC (HL)",			"ADC A",					/*	88-8f */
	"SUB B",				"SUB C",				"SUB D",				"SUB E",				"SUB H",				"SUB L",				"SUB (HL)",			"SUB A",					/*	90-97 */
	"SBC B",				"SBC C",				"SBC D",				"SBC E",				"SBC H",				"SBC L",				"SBC (HL)",			"SBC A",					/*	98-9f */
	...
	"RET NZ",				"POP BC",				"JP NZ,#h",			"JP #h",				"CALL NZ,#h",		"PUSH BC",			"ADD *h",				"RST 00h",				/*	c0-c7 */
	"RET Z",				"RET",					"JP Z,#h",			"PFX_CB",				"CALL Z,#h",		"CALL #h",			"ADC *h",				"RST 08h",				/*	c8-cf */
	"RET NC",				"POP DE",				"JP NC,#h",			"OUT (*h),A",		"CALL NC,#h",		"PUSH DE",			"SUB *h",				"RST 10h",				/*	d0-d7 */
	"RET C",				"EXX",					"JP C,#h",			"IN A,(*h)",		"CALL C,#h",		"PFX_DD",				"SBC *h",				"RST 18h",				/*	d8-df */
	"RET PO",				"POP HL",				"JP PO,#h",			"EX HL,(SP)",		"CALL PO,#h",		"PUSH HL",			"AND *h",				"RST 20h",				/*	e0-e7 */
...
/*0/8							1/9								2/A						3/B							4/C							5/D							6/E							7/F													*/
	...
	"ADD B",				"ADD C",				"ADD D",				"ADD E",				"ADD I%h",			"ADD I%l",			"ADD (I%+^h)",		"ADD A",				/*	80-87 */
	"ADC B",				"ADC C",				"ADC D",				"ADC E",				"ADC I%h",			"ADC I%l",			"ADC (I%+^h)",		"ADC,A",				/*	88-8f */
	"SUB B",				"SUB C",				"SUB D",				"SUB E",				"SUB I%h",			"SUB I%l",			"SUB (I%+^h)",		"SUB A",				/*	90-97 */
	"SBC B",				"SBC C",				"SBC D",				"SBC E",				"SBC I%h",			"SBC I%l",			"SBC (I%+^h)",		"SBC A",				/*	98-9f */
	...
	"RET NZ",				"POP BC",				"JP NZ,#h",			"JP #h",				"CALL NZ,#h",		"PUSH BC",			"ADD *h",					"RST 00h",			/*	c8-cf */
	"RET Z",				"RET",					"JP Z,#h",			"PFX_CB",				"CALL Z,#h",		"CALL #h",			"ADC *h",					"RST 08h",			/*	c8-cf */
	"RET NC",				"POP DE",				"JP NC,#h",			"OUT (*h),A",		"CALL NC,#h",		"PUSH DE",			"SUB *h",					"RST 10h",			/*	d0-d7 */
	"RET C",				"EXX",					"JP C,#h",			"IN A,(*h)",		"CALL C,#h",		"PFX_DD",				"SBC *h",					"RST 18h",			/*	d8-df */
	"RET PO",				"POP I%",				"JP PO,#h",			"EX I%,(SP)",		"CALL PO,#h",		"PUSH I%",			"AND *h",					"RST 20h",			/*	e0-e7 */
